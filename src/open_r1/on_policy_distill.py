...
from open_r1.configs import OnPolicyDistillConfig, OnPolicyDistillScriptArguments
...
if __name__ == "__main__":
    parser = TrlParser((OnPolicyDistillScriptArguments, OnPolicyDistillConfig, ModelConfig))
